...
//                        Log.d(TAG,"location updated");
    ...
    public void onLocationChanged(Location location) {
        ...
        if(preferences.getBoolean("Logged",false))
        {
            ...
            Log.d(TAG,"updating location of "+uid);
            argotAPI.geoPush(String.valueOf(location.getLatitude()),String.valueOf(location.getLongitude()),uid).enqueue(new Callback<in.ac.ksit.android.fitargot.Network.Model.Response>() {
                @Override
                public void onResponse(Call<in.ac.ksit.android.fitargot.Network.Model.Response> call, Response<in.ac.ksit.android.fitargot.Network.Model.Response> response) {
                    ...
                    if(response.code()==200)
                        ...
                        Log.d(TAG,"location posting failed at server end"+call.request().url().toString());
                }
