...
public class ArgotChallenge extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_argot_challenge, container, false);
        ...
        c1i2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (i == 0) {
                    Bitmap bitMap = BitmapFactory.decodeResource(ArgotChallenge.this.getResources(), R.drawable.template);
                    ...
                    Bitmap bitMap = BitmapFactory.decodeResource(ArgotChallenge.this.getResources(), R.drawable.argot1);
                    c1i2.setImageBitmap(bitMap);
                    ObjectAnimator flip = ObjectAnimator.ofFloat(c1i2, "rotationY", 0f, 180f);
                    flip.setDuration(300);
                    flip.start();
        ...
        c2i2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (i == 0) {
                    ...
                    Bitmap bitMap = BitmapFactory.decodeResource(ArgotChallenge.this.getResources(), R.drawable.argot2);
                    c2i2.setImageBitmap(bitMap);
                    ObjectAnimator flip = ObjectAnimator.ofFloat(c2i2, "rotationY", 0f, 180f);
                    flip.setDuration(300);
                    flip.start();
        ...
        c3i2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (i == 0) {
                    Bitmap bitMap = BitmapFactory.decodeResource(ArgotChallenge.this.getResources(), R.drawable.argot3);
                    ...
                    Bitmap bitMap = BitmapFactory.decodeResource(ArgotChallenge.this.getResources(), R.drawable.argot4);
                    c1i2.setImageBitmap(bitMap);
                    ObjectAnimator flip = ObjectAnimator.ofFloat(c3i2, "rotationY", 0f, 180f);
                    flip.setDuration(300);
                    flip.start();
